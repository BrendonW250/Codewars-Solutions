...
// Explanation:
// The first element in prod [] array 12 is the product of all array's 
...
function productArray(numbers){
    ...
    //   multiply until you get the product 
    //   of the entire arra
    for (let i=0; i<numbers.length; i++){
        a *= numbers[i]
    }

    //   loop through the array again to divide the product --> 'a'
    //   by each element in the array
    //   as that's happening divide each element by a and push the number to
    //   the output array
    for (let i=0; i<numbers.length; i++){
