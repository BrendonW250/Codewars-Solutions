...
// Task
// Given an array of integers, remove the smallest value. Do 
// not mutate the original array/list. If there are multiple 
// elements with the same value, remove the one with a lower 
