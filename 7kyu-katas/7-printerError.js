// In a factory a printer prints labels for boxes. For 
// one kind of boxes the printer has to use colors which, 
// for the sake of simplicity, are named with letters from a to m.

// The colors used by the printer are recorded in a 
// control string. For example a "good" control string would
//  be aaabbbbhaijjjm meaning that the printer used three times 
...
// is produced e.g. aaaxbbbbyyhwawiwjjjwwm with letters 
// not from a to m.

// You have to write a function printer_error which given 
// a string will return the error rate of the printer as a 
// string representing a rational whose numerator is the number
